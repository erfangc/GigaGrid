...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./giga-grid.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./giga-grid.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GigaStore_2 = __webpack_require__(11);
	...
	var GigaGrid = (function (_super) {
	    ...
	    GigaGrid.prototype.dispatchDisplayBoundChange = function () {
	        ...
	        var action = {
	            type: GigaStore_2.GigaActionType.CHANGE_ROW_DISPLAY_BOUNDS,
	            canvas: $canvas,
	            viewport: $viewport,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreeBuilder_1 = __webpack_require__(14);
	var utils_1 = __webpack_require__(16);
	var SortFactory_1 = __webpack_require__(35);
	...
	var GigaStore = (function (_super) {
	    ...
	    GigaStore.prototype.reduce = function (state, action) {
	        ...
	        switch (action.type) {
	            ...
	            case GigaActionType.NEW_SUBTOTAL:
	                newState = this.handleSubtotal(state, action);
	                break;
	            ...
	            case GigaActionType.ADD_SORT:
	                newState = GigaStore.handleAddSort(state, action);
	                break;
	            case GigaActionType.NEW_SORT:
	                newState = GigaStore.handleNewSort(state, action);
	                break;
	            case GigaActionType.CLEAR_SORT:
	                newState = GigaStore.handleClearSort(state, action);
	                break;
	            /*
	             Selection Actions
	             */
	     ...
	     */
	    GigaStore.handleAddSort = function (state, action) {
	    ...
	    GigaStore.handleNewSort = function (state, action) {
	    ...
	    GigaStore.handleClearSort = function (state, action) {
	...
	/*
	 Public Actions API
	 */
	(function (GigaActionType) {
	    GigaActionType[GigaActionType["INITIALIZE"] = 0] = "INITIALIZE";
	    GigaActionType[GigaActionType["NEW_SUBTOTAL"] = 1] = "NEW_SUBTOTAL";
	    GigaActionType[GigaActionType["ADD_SUBTOTAL"] = 2] = "ADD_SUBTOTAL";
	    GigaActionType[GigaActionType["CLEAR_SUBTOTAL"] = 3] = "CLEAR_SUBTOTAL";
	    GigaActionType[GigaActionType["NEW_SORT"] = 4] = "NEW_SORT";
	    GigaActionType[GigaActionType["ADD_SORT"] = 5] = "ADD_SORT";
	    GigaActionType[GigaActionType["CLEAR_SORT"] = 6] = "CLEAR_SORT";
	    GigaActionType[GigaActionType["NEW_FILTER"] = 7] = "NEW_FILTER";
	    GigaActionType[GigaActionType["ADD_FILTER"] = 8] = "ADD_FILTER";
	    GigaActionType[GigaActionType["CLEAR_FILTER"] = 9] = "CLEAR_FILTER";
	    GigaActionType[GigaActionType["TOGGLE_ROW_COLLAPSE"] = 10] = "TOGGLE_ROW_COLLAPSE";
	    GigaActionType[GigaActionType["COLLAPSE_ALL"] = 11] = "COLLAPSE_ALL";
	    GigaActionType[GigaActionType["EXPAND_ALL"] = 12] = "EXPAND_ALL";
	    GigaActionType[GigaActionType["TOGGLE_ROW_SELECT"] = 13] = "TOGGLE_ROW_SELECT";
	    GigaActionType[GigaActionType["TOGGLE_CELL_SELECT"] = 14] = "TOGGLE_CELL_SELECT";
	    GigaActionType[GigaActionType["TABLE_WIDTH_CHANGE"] = 15] = "TABLE_WIDTH_CHANGE";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.Container = __webpack_require__(17);
	module.exports.MapStore = __webpack_require__(22);
	module.exports.Mixin = __webpack_require__(34);
	module.exports.ReduceStore = __webpack_require__(23);
	module.exports.Store = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStoreGroup = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxReduceStore = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FluxStore = __webpack_require__(24);
	
	var abstractMethod = __webpack_require__(32);
	var invariant = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmitterSubscription = __webpack_require__(27);
	var EventSubscriptionVendor = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventSubscription = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortFactory = (function () {
	    ...
	    SortFactory.sortTree = function (tree, sortBys) {
	    ...
	    SortFactory.recursivelyExecuteSort = function (rootRow, fn) {
	        if (rootRow.getNumChildren() !== 0) {
	            ...
	            rootRow.getChildren().forEach(function (child) {
	    ...
	    SortFactory.createCompositeSortFn = function (sortBys) {
	    ...
	    SortFactory.resolveSortFn = function (sortBy) {
	    ...
	    SortFactory.getColumnValueForRow = function (row, sortBy) {
	        if (row.isDetail())
	            return row.get(sortBy);
	        else if (row.get(sortBy) !== null && row.get(sortBy) !== undefined && row.get(sortBy) !== "")
	            return row.get(sortBy);
	        else
	            return row.title;
	    };
	    SortFactory.buildLexicalSortFn = function (sortBy) {
	        return function (a, b) {
	            var valA = SortFactory.getColumnValueForRow(a, sortBy);
	            var valB = SortFactory.getColumnValueForRow(b, sortBy);
	            var result = 0;
	            if (!valA || !valB) {
	                if (valA)
	            ...
	            if (sortBy.direction === ColumnLike_1.SortDirection.DESC)
	                result = result * -1;
	            return result;
	        };
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = __webpack_require__(42);
	var ColumnLike_1 = __webpack_require__(13);
	var DropdownMenu_1 = __webpack_require__(46);
	...
	var TableHeaderCell = (function (_super) {
	    ...
	    TableHeaderCell.prototype.renderDropdownMenu = function () {
	        ...
	        }, text: "Collapse All", isLastColumn: this.props.isLastColumn}), React.createElement(DropdownMenu_1.SimpleDropdownMenuItem, {onClick: function () {
	            _this.props.dispatcher.dispatch({
	    ...
	    TableHeaderCell.prototype.render = function () {
	        ...
	        var cx = classNames({
	            "table-header": true,
	            "numeric": columnDef.format === ColumnLike_1.ColumnFormat.NUMBER,
	            "non-numeric": columnDef.format !== ColumnLike_1.ColumnFormat.NUMBER
	        });
	        return (React.createElement("th", {style: style, onMouseEnter: function () { return _this.setState({ handleVisible: true }); }, onMouseLeave: function () { return _this.setState({ handleVisible: false }); }, className: cx}, React.createElement("span", {className: "header-text"}, columnDef.title || columnDef.colTag), this.renderSortIcon(), this.renderDropdownMenu()));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM = __webpack_require__(7);
	var $ = __webpack_require__(10);
	var className = __webpack_require__(42);
	/**
	...
	var DropdownMenu = (function (_super) {
	    ...
	    DropdownMenu.prototype.toggleDisplay = function () {
	        this.setState({
	    ...
	    DropdownMenu.prototype.componentDidMount = function () {
	        ...
	        this.clickOutsideHandler = function (event) {
	            ...
	            if (_this.props.toggleHandle)
	                toggleHandle = _this.props.toggleHandle();
	            if (!$(event.target).closest(ReactDOM.findDOMNode(_this)).length && _this.state.visible)
	        ...
	        var parentZIndex = parent.style.zIndex;
	        (ReactDOM.findDOMNode(this)).style.zIndex = parentZIndex + 1;
	    };
	 ...
	 * into a submenu
	 */
	var SimpleDropdownMenuItem = (function (_super) {
	    __extends(SimpleDropdownMenuItem, _super);
	    function SimpleDropdownMenuItem(props) {
	        _super.call(this, props);
	    }
	    SimpleDropdownMenuItem.prototype.handleClick = function (e) {
	        e.preventDefault();
	        e.stopPropagation();
	        if (this.subMenuRef)
	    ...
	    SimpleDropdownMenuItem.prototype.renderSubMenu = function () {
	        var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortMenuItem = (function (_super) {
	    ...
	    SortMenuItem.prototype.dispatchSortAction = function (action) {
	        this.props.dispatcher.dispatch(action);
	    };
	    SortMenuItem.prototype.createSortByFromColumnDef = function (dir) {
	        function reverseSortDirection(dir) {
	            if (dir === undefined)
	                return ColumnLike_1.SortDirection.DESC;
	            else if (dir === ColumnLike_1.SortDirection.ASC)
	                return ColumnLike_1.SortDirection.DESC;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubtotalByMenuItem = (function (_super) {
	    ...
	    SubtotalByMenuItem.prototype.onCancel = function (e) {
	        this.props.dispatcher.dispatch({
	            type: GigaStore_1.GigaActionType.CLEAR_SUBTOTAL
	        });
	    };
	    SubtotalByMenuItem.prototype.renderAddSubtotal = function () {
	        var _this = this;
	        var cx = classNames({
...
;
//# sourceMappingURL=giga-grid.js.map