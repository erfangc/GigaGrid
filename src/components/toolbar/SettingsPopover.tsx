...
export class SettingsPopover extends React.Component<SettingsPopoverProps, SettingsPopoverState> {
    ...
    constructor(props: SettingsPopoverProps) {
        ...
        const subtotalBys = [...props.subtotalBys];
    ...
    private moveColumn(columns: Column[], src: SortableDataTransfer, dest: SortableDataTransfer) {
        ...
        const destIdx = columns.findIndex(c => c.colTag === dest.colTag);
        ...
        const items = columns.map((c, i) =>
            <SortableItem
                ...
                onClick={(function (column: Column) {
                    this.setState(Object.assign({}, this.state, { activeColumn: column }));
                }).bind(this)}
    ...
    private renderColumnConfigurer(column?: Column): JSX.Element | string {
        ...
        function onTitleChange(e: SyntheticEvent<any>) {
            ...
            this.setState(Object.assign({}, this.state, { column: column }));
        }

        function onAggregationMethodChange(e: SyntheticEvent<any>) {
            e.preventDefault();
        ...
        function onFormatChange(e: SyntheticEvent<any>) {
            e.preventDefault();
            //noinspection TypeScriptValidateTypes
            ...
            <div className="giga-grid-flex-column column-50">
                <div>
                    ...
                    <span className="giga-grid-button dismiss"
                        onClick={() => this.setState(Object.assign({}, this.state, { activeColumn: undefined }))}><i
