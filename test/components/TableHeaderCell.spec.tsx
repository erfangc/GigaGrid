...
describe('clicking on a header cell should sort by that header', ()=> {
    ...
    let component:React.Component<{},{}> = null;
    const dispatcher = new Dispatcher();

    let sortAction:SortUpdateAction  = null;
    ...
    it('should fire sort actions when clicked even if the column does not specify a sort direction', ()=> {
        ...
        ReactTestUtils.Simulate.click(ReactTestUtils.findRenderedDOMComponentWithClass(component, 'cell'));
