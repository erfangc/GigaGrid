import { viewportResizeReducer } from '../../../src/store/handlers/ViewportResizeReducer';
import { GigaActionType, ColumnDef, Column } from '../../../src/index';

describe('ViewportResizeReducer', () => {
    it('should take an input state, an action with a new screen size and return a new state with updated colum widths and scrollable div max-width', () => {
        ...
        let newState = viewportResizeReducer(state, { newGridWidth: '400px', type: GigaActionType.VIEWPORT_RESIZE }, props);
